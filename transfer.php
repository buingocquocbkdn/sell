	            ...
	            <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
					...
					<div class="ap-dung-jquery">
						<form action="javascript:void(0)" method="" role="form">
							<legend>Vui lòng chuyển tiền tới số tài khoản 
								<br>
								0109641849 ngân hàng Đông Á chi nhánh Liên Chiểu
								<br>
								bằng phương thức Internet Banking
								<br>
								Sau khi nhận được tiền chúng tối sẽ gởi thông tin liên kết tới email của bạn
							</legend>
							<label>Vui lòng chọn ngân hàng:</label>
							<br>
							<select name="bank" value="Bank">
								<option value="Đông Á Bank">Đông á Bank</option>
								<option value="Agribank">AgriBank</option>
								<option value="VietTin Bank">VietTinBank</option>
								<option value="TechCom Bank">TechComBank</option>
